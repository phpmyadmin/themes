...
#floating_menubar{
	left:-3px!important;
	/*margin-left:<?php echo $GLOBALS['cfg']['NaviWidth']; ?>px;*/
}
/* topmenu */
#topmenu a{
    text-shadow:0 1px 0 #fff;
...
<?php /*#loading_parent{width:100%;position:relative;}*/?>
#loading_parent{
	top:0;
	left:0;
	right:0;
...
.navigation {
    margin: .8em 0;
	background-color:<?php echo $GLOBALS['cfg']['white']; ?>;
}
...
#pma_console .toolbar .console_switch .icon{
	margin-right:.3em;
}
#pma_console .content {
    overflow-x: hidden;
...
.ui-datepicker .ui-slider{position:relative}
...
.ui-datepicker .ui-slider-handle{top:-2px;border:none;background:<?php echo $GLOBALS['cfg']['cSec'];?>;border-radius:50%}
